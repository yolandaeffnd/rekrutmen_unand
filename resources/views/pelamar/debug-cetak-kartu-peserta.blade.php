    ...
    <header>
        <div style="margin: 5px;">
            <table style="width:100%;">
                <tr>
                    <td style="text-align:center; width:20%;"><img width='50px' src='{{ public_path('img/unand.png') }}'>
                    </td>
    ...
    <main>
        <div style="page-break-after: always; ">
            ...
            <p style="text-align: center; margin-top:30;"><b>
                    ...
                    PEGAWAI TETAP UNIVERSITAS ANDALAS<br>
                    TAHUN 2023</b>
            </p>
                        ...
                        <td>
                            <table style="">
                                ...
                                <tr>
                                    <td>Pendidikan</td>
                                    <td>:</td>
                                    <td>{{ $dataResume_generate['biodata']['Jenjang Studi'] }} -
                                        {{ $dataResume_generate['biodata']['Program Studi'] }}</td>
                                </tr>
                                <tr>
